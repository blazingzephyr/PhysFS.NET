...
[CustomMarshaller(typeof(int), MarshalMode.UnmanagedToManagedOut, typeof(IntegerAsVoidMarshaller))]
#pragma warning restore SYSLIB1057 // Marshaller type does not have the required shape
public static class IntegerAsVoidMarshaller
{
    /// <summary>
    /// Swallow the exception and return nothing.
    /// </summary>
    /// <param name="e">The exception.</param>
    public static void ConvertToManaged(int e)
    {
